    ...
    <Layout className="shell">
      ...
      <Layout.Content className="content">
        <Tabs items={[
          ...
          { key: 'board', label: '协作看板', children: <><Card title="每日安排"><List dataSource={['Day 1 抵达与集合','Day 2 环洱海','Day 3 沙溪古镇']} renderItem={item => <List.Item>{item}</List.Item>} /></Card><BudgetBoard /></> },
